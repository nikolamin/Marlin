...
#define CUSTOM_MACHINE_NAME "Z5 M2"
...
#define STRING_CONFIG_H_AUTHOR "(ZONESTAR, Nikola M)" // Who made the changes.
 ...
 */
#if EITHER(OPTION_PL08N, OPTION_BLTOUCH)
